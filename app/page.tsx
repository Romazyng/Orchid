  ...
  return (
    <main className="flex flex-col min-h-screen w-full overflow-x-hidden" >
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen bg-black text-white md:h-152 w-full">
            ...
            <div className="flex justify-center items-center absolute bottom-0 w-[50%] ">
              {/* <Image
              ...
              /> */}
              <div className="md:w-[3rem] lg:w-[4rem] sm:w-[2rem] translate-y-[-20px] ">
              <svg
...
//             <strong>Build your</strong> <i className="font-light">own</i> <strong>story</strong>
//           </p>
//           <h1 className="text-[#747272] text-lg sm:text-xl md:text-2xl lg:text-3xl mt-4">
//             based on your preferences.
//           </h1>
//         </div>
...
//       {/* Idea Section */}
//       <section className="flex flex-col items-center mt-48 h-95 text-black fade-in opacity-0 transform translate-y-10 transition-all duration-1000">
//         <div className="text-[6vw] md:text-[4rem] font-medium text-center">
//           <span>
//             Our job is to help you find that<br /> <i className="font-light">idea</i> and make it legendary
//           </span>
//         </div>
...
//       <section className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 mt-8 md:mt-16 px-4">
//         <div className="w-full md:w-1/3 max-w-sm rounded-lg overflow-hidden shadow-lg">
...
//           />
//         </div>
//         <div className="w-full md:w-1/3 max-w-sm rounded-lg overflow-hidden shadow-lg relative">
...
//       <section className="flex flex-col items-center mt-36 fade-in opacity-0 transform translate-y-10 transition-all duration-1000">
...
//       <section className="min-h-screen py-12 md:py-24 bg-white">
//         {/* Roman Chernetsky */}
//         <motion.div
...
//                 width={355}
//                 height={355}
//                 className="w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto rounded-lg shadow-lg"
//               />
//             </div>
...
//               <p className="text-xl md:text-2xl text-[#0099FF] font-semibold">CEO, Frontend</p>
//               <p className="text-lg md:text-xl text-[#747272]">
//                 I believe that success comes from bold ideas, relentless determination, and the courage to challenge the status quo...
//               </p>
//             </div>
//           </div>
//         </motion.div>
...
//               <p className="text-xl md:text-2xl text-[#0099FF] font-semibold">Co-Founder, Backend</p>
//               <p className="text-lg md:text-xl text-[#747272]">
//                 I want to remind you that our work is the backbone of innovation...
//               </p>
//             </div>
...
//                 width={355}
//                 height={355}
//                 className="w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto rounded-lg shadow-lg transform -scale-x-100"
//               />
//             </div>
//             <div className="order-2 md:order-2 space-y-4 text-center md:text-left">
//               <h3 className="text-2xl md:text-3xl font-bold">Klim Popov</h3>
//               <p className="text-xl md:text-2xl text-[#0099FF] font-semibold">Co-Founder, AI</p>
//               <p className="text-lg md:text-xl text-[#747272]">
...
//       {/* Contact Section */}
//       <section id='contact' className="bg-black py-12 md:py-24 mt-12 md:mt-24">
